...
const Categories = () => {
  ...
  return (
    <>
      <div className="container mx-auto px-7 absolute z-50">
        <button
        ...
        {show && (
          <>
            ...
            <div className="daily-offer text-[18px] bg-gray-100  py-5 w-44">
